...
class TestSchemaSQLite3_GenerateDeleteAll(TestCase):
    def test_GenerateDeleteAll_pattern_01(self):
        test = SchemaSQLite3()
        fieldDefineList = []
        ...
        result = test.GenerateDeleteAll(entityModel)
        self.assertEqual(result, 'DELETE FROM AAAA_BBBB_CCCC')
