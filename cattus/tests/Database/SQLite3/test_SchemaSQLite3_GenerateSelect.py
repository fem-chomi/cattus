...
class TestSchemaSQLite3_GenerateSelect(TestCase):
    def test_GenerateSelect_pattern_01(self):
        test = SchemaSQLite3()
        fieldDefineList = []
        ...
        result = test.GenerateSelect(entityModel)
        self.assertEqual(result, 'SELECT EEEE_FFFF_GGGG, IIII_JJJJ_KKKK, MMMM_NNNN_OOOO FROM AAAA_BBBB_CCCC WHERE EEEE_FFFF_GGGG = @EeeeFfffGggg')
