...
class TestCSharpLanguage_GenerateFunction(TestCase):
    def setUp(self):
        SourceLine.Reset()
    ...
    def test_GenerateMethod_pattern_01(self):
        ...
        self.assertEqual(result[0], 'private long AaaaBbbbCccc(sbyte eeeeFfffGggg, short iiiiJjjjKkkk, int mmmmNnnnOooo) {\r\n')
