namespace AaaaBbbbCccc {
    ...
    public class AaaaBbbbCcccEntity {
        ...
        public AaaaBbbbCcccEntity(sbyte eeeeFfffGggg, short iiiiJjjjKkkk, int mmmmNnnnOooo) {
            this.eeeeFfffGggg = eeeeFfffGggg;
            this.iiiiJjjjKkkk = iiiiJjjjKkkk;
            this.mmmmNnnnOooo = mmmmNnnnOooo;
        }

        public AaaaBbbbCcccEntity(sbyte eeeeFfffGggg=1, short iiiiJjjjKkkk=2, int mmmmNnnnOooo=3) {
            this.eeeeFfffGggg = eeeeFfffGggg;
            this.iiiiJjjjKkkk = iiiiJjjjKkkk;
            this.mmmmNnnnOooo = mmmmNnnnOooo;
        }
        ...
        public AaaaBbbbCcccEntity ImportFile(string filename) {
        }
